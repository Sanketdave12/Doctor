            ...
            <div class="col-md-12">
                ...
                <div class="testi-slider">
                    <div class="testimonial-wrap">
                        <img src="/static/images/testi-img1.jpg" class="img-fluid testi-img-icon" alt="#" />
                        <ul>
                        ...
                        <div class="testi-styled-bg">
                            <img src="/static/images/testi-side-img_05.png" class="img-fluid" alt="#" />
                        </div>
                    </div>
                    <div class="testimonial-wrap quaternary-br-color">
                        <img src="/static/images/testi-img2.jpg" class="img-fluid testi-img-icon" alt="#" />
                        <ul>
                            <li><i class="fas fa-star"></i></li>
                            <li><i class="fas fa-star"></i></li>
                            <li><i class="fas fa-star"></i></li>
